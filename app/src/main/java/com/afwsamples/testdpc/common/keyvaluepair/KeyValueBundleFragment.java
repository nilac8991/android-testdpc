...
public class KeyValueBundleFragment extends ManageAppFragment
        implements OnEditButtonClickListener<String>, OnDeleteButtonClickListener<String> {
    ...
    private void showEditDialog(final String key) {
        ...
        KeyValuePairDialogFragment dialogFragment =
                KeyValuePairDialogFragment.newInstance(type, true, key, "", value, SUPPORTED_TYPE, mAppName);
    ...
    private static class StringEditDeleteArrayAdapter extends EditDeleteArrayAdapter<String> {
        ...
        public StringEditDeleteArrayAdapter(
                Context context,
                List<String> entries,
                OnEditButtonClickListener<String> onEditButtonClickListener,
                OnDeleteButtonClickListener<String> onDeleteButtonClickListener) {
