...
import static com.afwsamples.testdpc.common.keyvaluepair.KeyValuePairDialogFragment.ARG_INITIAL_VALUE;
...
public class KeyValueBundleArrayFragment extends ManageAppFragment
        implements OnEditButtonClickListener<Bundle>, OnDeleteButtonClickListener<Bundle> {
    /**
     ...
     */
    public static KeyValueBundleArrayFragment newInstance(
            String key, Bundle[] bundles, String appName) {
    ...
    public View onCreateView(
        ...
        mHeaderView.setText(getActivity().getString(R.string.app_restrictions_info, mAppName, mKey));
        return view;
    }
    ...
    private void showEditDialog(final Bundle bundle) {
        ...
        KeyValuePairDialogFragment dialogFragment =
                KeyValuePairDialogFragment.newInstance(
                        type, false, "Bundle #" + index, "", bundle, SUPPORTED_TYPE, mAppName);
    ...
    private class BundleEditDeleteArrayAdapter extends EditDeleteArrayAdapter<Bundle> {
        ...
        public BundleEditDeleteArrayAdapter(
                Context context,
                List<Bundle> entries,
                OnEditButtonClickListener<Bundle> onEditButtonClickListener,
                OnDeleteButtonClickListener<Bundle> onDeleteButtonClickListener) {
