...
/**
 * Allows the user to see / edit / delete affiliation ids. See {@link
 * DevicePolicyManager#setAffiliationIds(ComponentName, Set)}
 */
public class ManageAffiliationIdsFragment extends BaseStringItemsFragment {
  ...
  public ManageAffiliationIdsFragment() {
    super(
        R.string.manage_affiliation_ids,
        R.string.enter_affiliation_id,
